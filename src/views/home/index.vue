    ...
    <a-row :gutter="24">
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" title="总销售额" total="￥126,560">
          ...
          <div>
            <trend type="up" percentage="12" term="周同比" style="margin-right: 16px;" />
            <trend percentage="11" term="日同比" />
          </div>
      ...
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" title="运营活动效果" total="78%">
          ...
          <template slot="footer">
            <trend flag="down" percentage="12" term="周同比" style="margin-right: 16px;" />
            <trend flag="up" percentage="80" term="日同比" />
          </template>
        </chart-card>
      </a-col>
    </a-row>
            ...
            <div class="ant-table-wrapper">
              ...
              >
                <span slot="range" slot-scope="text, record">
                  <trend :flag="record.status === 0 ? 'up' : 'down'" :percentage="text" />
                </span>
              </a-table>
            </div>
          </a-card>
